...
+-------------+------+-----------+--------------------------+
| 1           | 1    | Charge    | $I= $ \SI{0.7}{\coulomb} |
+-------------+------+-----------+--------------------------+
| 1           | 2    | Pause     | \SI{30}{\minute}         |
+-------------+------+-----------+--------------------------+
| 10          | 3    | Discharge | $I= $ \SI{1}{\coulomb}   |
+             +------+-----------+--------------------------+
|             | 4    | Pause     | \SI{30}{\minute}         |
+             +------+-----------+--------------------------+
|             | 5    | Charge    | $I= $ \SI{0.7}{\coulomb} |
+             +------+-----------+--------------------------+
|             | 6    | Pause     | \SI{30}{\minute}         |
+-------------+------+-----------+--------------------------+
| 1           | 7    | Pause     | \SI{60}{\minute}         |
+-------------+------+-----------+--------------------------+
...
| Repetitions | Step | Type      | Description              |
+-------------+------+-----------+--------------------------+
| 50          | 1    | Discharge | $I= $ \SI{1}{\coulomb}   |
+             +------+-----------+--------------------------+
|             | 2    | Pause     | \SI{30}{\minute}         |
+             +------+-----------+--------------------------+
|             | 3    | Charge    | $I= $ \SI{0.7}{\coulomb} |
+             +------+-----------+--------------------------+
|             | 4    | Pause     | \SI{30}{\minute}         |
+-------------+------+-----------+--------------------------+
...
| 1           | 1    | Charge    | $I= $ \SI{0.7}{\coulomb} |
+-------------+------+-----------+--------------------------+
| 1           | 2    | Pause     | \SI{60}{\minute}         |
+-------------+------+-----------+--------------------------+
| 1           | 3    | Discharge | $I= $ \SI{1}{\coulomb}   |
+-------------+------+-----------+--------------------------+
| 1           | 4    | Pause     | \SI{30}{\minute}         |
+-------------+------+-----------+--------------------------+
| 1           | 5    | Charge    | $I= $ \SI{0.7}{\coulomb} |
+-------------+------+-----------+--------------------------+
| 1           | 6    | Pause     | \SI{30}{\minute}         |
+-------------+------+-----------+--------------------------+
| 20          | 7    | Discharge | $I= $ \SI{1}{\coulomb}   |
+             +------+-----------+--------------------------+
|             | 8    | Pause     | \SI{3}{\minute}          |
+-------------+------+-----------+--------------------------+
| 1           | 9    | Pause     | \SI{60}{\minute}         |
+-------------+------+-----------+--------------------------+
| 20          | 10   | Charge    | $I= $ \SI{1}{\coulomb}   |
+             +------+-----------+--------------------------+
|             | 11   | Pause     | \SI{3}{\minute}          |
+-------------+------+-----------+--------------------------+
| 1           | 12   | Pause     | \SI{60}{\minute}         |
+-------------+------+-----------+--------------------------+
| 1           | 13   | Discharge | $I= $ \SI{1}{\coulomb}   |
+-------------+------+-----------+--------------------------+
| 1           | 14   | Pause     | \SI{30}{\minute}         |
+-------------+------+-----------+--------------------------+
| 1           | 15   | Charge    | $I= $ \SI{0.7}{\coulomb} |
+-------------+------+-----------+--------------------------+
| 1           | 16   | Pause     | \SI{30}{\minute}         |
+-------------+------+-----------+--------------------------+
...
+-------------+------------------+-------------------+
| 1           | Training         | \SI{25}{\celsius} |
+-------------+------------------+-------------------+
| 6           | Characterization | \SI{25}{\celsius} |
+             +------------------+-------------------+
|             | Ageing A         | \SI{25}{\celsius} |
+-------------+------------------+-------------------+
| 1           | Characterization | \SI{25}{\celsius} |
+-------------+------------------+-------------------+
...
| 1           | Characterization | \SI{25}{\celsius} |
+-------------+------------------+-------------------+
| 2           | Ageing A         | \SI{40}{\celsius} |
+             +------------------+-------------------+
|             | Characterization | \SI{25}{\celsius} |
+             +------------------+-------------------+
|             | Characterization | \SI{40}{\celsius} |
+-------------+------------------+-------------------+
